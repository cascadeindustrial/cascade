...
data[this.options.sessionProductKey][itemId]=value;checkoutDataQuotation.setQuotationProductsFromData(data);},saveData:function(){updateQuote(true).done(function(){fullScreenLoader.stopLoader(true);});},getItemId:function(){return this.options.itemId;},getValue:function(){return $(this.element).val();},setValue:function(value){$(this.element).val(value);},toggleDisabled:function(){$(this.element).prop('disabled',function(i,v){return!v;});}});return $.mage.quotationBiddingUpdate;});