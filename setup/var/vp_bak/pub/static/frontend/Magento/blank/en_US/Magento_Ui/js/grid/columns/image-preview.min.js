...
this.lastOpenedImage(record._rowIndex);},updateHeight:function(){this.height($(this.previewImageSelector).height()+'px');},hide:function(){this.lastOpenedImage(null);this.visibleRecord(null);this.height(0);this._selectRow(null);},isVisible:function(record){if(this.lastOpenedImage()===record._rowIndex&&this.visibleRecord()===null){this.show(record);}
