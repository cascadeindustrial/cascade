define(['jquery'],function($){'use strict';$.widget('amasty.stickyWidget',{options:{parentContainer:'[data-amsticky-js="main-container"]',element:'[data-amsticky-js="sticky-element"]',scrollContentContainer:'[data-amsticky-js="scroll-element"]',stopper:'[data-amsticky-js="stopper"]',stickyOffset:{top:0,left:0},stickyPosition:'right',stickyClass:'-sticky',disableBreakpoint:1024},_create:function(){var toggleSticky=this.stickyToggle.bind(this),windowGlobal=window;if($(windowGlobal).width()>=this.options.disableBreakpoint){if($(this.options.scrollContentContainer).length){this.stickyPosition(this.options.stickyPosition);};$(windowGlobal).off('scroll',toggleSticky).on('scroll',toggleSticky);}
