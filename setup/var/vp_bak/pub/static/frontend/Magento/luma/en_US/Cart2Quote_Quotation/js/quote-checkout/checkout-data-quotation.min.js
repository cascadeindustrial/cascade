define(['jquery','Magento_Customer/js/customer-data'],function($,storage){'use strict';var cacheKey='checkout-data-quotation';var data;var getData=function(){if($.isEmptyObject(data)){data={'quotation_guest_field_data':getCheckoutConfig("quotation_guest_field_data"),'quotation_field_data':getCheckoutConfig("quotation_field_data"),'quotation_product_data':getCheckoutConfig("quotation_product_data"),'quotation_store_config_data':getCheckoutConfig("quotation_store_config_data")};saveData(data);}
