...
itemDetails=this.storage().get('item_details'+item.item_id+propertyName);return itemDetails?itemDetails:false;},getItemFromQuote:function(item){var items=quote.getItems();var quoteItems=items.filter(function(quoteItem){return quoteItem.item_id==item.item_id;});if(quoteItems.length==0){return false;}
