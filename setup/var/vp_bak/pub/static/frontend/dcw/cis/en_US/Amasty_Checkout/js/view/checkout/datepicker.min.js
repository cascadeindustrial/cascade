...
var date=moment(observable(),config.elem.pickerDateTimeFormat);$(el).calendar(options);observable()&&$(el).datepicker('setDate',date.format('YYYY-MM-DD'));$(el).blur();ko.utils.registerEventHandler(el,'change',function(){observable(this.value);});}};});