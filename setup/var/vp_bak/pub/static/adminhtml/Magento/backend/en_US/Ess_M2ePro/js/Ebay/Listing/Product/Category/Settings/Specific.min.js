...
if(length==1||parseInt(tbody.getAttribute('data-min_values'))>=length){var btnRemove=tbody.getElementsByClassName('btn_value_remove');for(var i=0;i<btnRemove.length;i++){btnRemove[i].hide();}}}});});