define([],function(){window.ProgressBar=Class.create();ProgressBar.prototype={initialize:function(progressBarId){if(typeof progressBarId=='undefined'){progressBarId='';}
...
this.status=string;$(this.progressBarId+'_status').innerHTML=this.status;}};});