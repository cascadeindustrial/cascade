...
setTimeout(function(){this.sendPartsProducts(parts,partsCount,onComplete);}.bind(this),500);}.bind(this)});$$('.loading-mask').invoke('setStyle',{visibility:'hidden'});}});});