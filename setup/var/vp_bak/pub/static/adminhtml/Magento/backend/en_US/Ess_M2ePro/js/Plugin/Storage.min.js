define(['jquery','underscore','jquery/jquery-storageapi'],function(jQuery,_){var M2EPRO_STORAGE_KEY='m2epro_data',_storage=jQuery.localStorage;function initStorage(){var data=_storage.get(M2EPRO_STORAGE_KEY);if(!_.isNull(data)&&_.isObject(data)){return data;}
...
delete data[key];});_storage.set(M2EPRO_STORAGE_KEY,data);},removeAll:function(){_storage.set(M2EPRO_STORAGE_KEY,{});return true;}};});