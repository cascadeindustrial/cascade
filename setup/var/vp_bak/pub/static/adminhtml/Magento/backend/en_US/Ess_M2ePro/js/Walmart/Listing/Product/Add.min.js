define(['M2ePro/Common'],function(){window.WalmartListingProductAdd=Class.create();WalmartListingProductAdd.prototype=Object.extend(new Common(),{initialize:function(ProgressBarObj,WrapperObj){this.categories='';this.products='';this.listing_id=null;this.is_list=null;this.back='';this.emptyListing=0;this.categoriesAddAction=null;this.categoriesDeleteAction=null;this.progressBarObj=ProgressBarObj;this.wrapperObj=WrapperObj;},add:function(items,back,isList){var self=this;self.is_list=isList;self.back=back;self.getListingId(items);if(self.emptyListing==1){return;}
...
setTimeout(function(){self.sendPartsProducts(parts,partsCount);},500);}});$$('.loading-mask').invoke('setStyle',{visibility:'hidden'});},setHideProductsPresentedInOtherListings:function(hideProductsOthersListings){this.hideProductsOthersListings=hideProductsOthersListings;}});});