...
if(typeof callback=='function'){callback();}}.bind(this)});},globalStepTwo:function(){ListingAutoActionObj.collectData();var callback=function(){jQuery('#'+ListingAutoActionObj.getPopupMode()+'modal_auto_action > .block_notices:first').remove();jQuery('#'+ListingAutoActionObj.getPopupMode()+'continue_button').off('click').on('click',ListingAutoActionObj.globalStepThree);ListingAutoActionObj.highlightBreadcrumbStep(2);};ListingAutoActionObj.loadCategoryChooser(callback);},globalStepThree:function(){if(!EbayListingProductCategorySettingsChooserObj.validate()){return;}
ListingAutoActionObj.collectData();var callback=function(){ListingAutoActionObj.highlightBreadcrumbStep(3);$(ListingAutoActionObj.getPopupMode()+'confirm_button').show();$(ListingAutoActionObj.getPopupMode()+'reset_button').show();$(ListingAutoActionObj.getPopupMode()+'continue_button').hide();};ListingAutoActionObj.loadSpecific(callback);},websiteStepTwo:function(){ListingAutoActionObj.collectData();var callback=function(){jQuery('#'+ListingAutoActionObj.getPopupMode()+'modal_auto_action > .block_notices:first').remove();jQuery('#'+ListingAutoActionObj.getPopupMode()+'continue_button').off('click').on('click',ListingAutoActionObj.websiteStepThree);ListingAutoActionObj.highlightBreadcrumbStep(2);};ListingAutoActionObj.loadCategoryChooser(callback);},websiteStepThree:function(){if(!EbayListingProductCategorySettingsChooserObj.validate()){return;}
ListingAutoActionObj.collectData();var callback=function(){ListingAutoActionObj.highlightBreadcrumbStep(3);$(ListingAutoActionObj.getPopupMode()+'confirm_button').show();$(ListingAutoActionObj.getPopupMode()+'reset_button').show();$(ListingAutoActionObj.getPopupMode()+'continue_button').hide();};ListingAutoActionObj.loadSpecific(callback);},categoryStepOne:function(groupId){var mode=ListingAutoActionObj.getPopupMode();this.loadAutoCategoryForm(groupId,function(){$(mode+'close_button').hide();});},categoryStepTwo:function(){if(!ListingAutoActionObj.validate()){return;}
ListingAutoActionObj.collectData();var mode=ListingAutoActionObj.getPopupMode();var callback=function(){jQuery('#'+mode+'continue_button').off('click').on('click',ListingAutoActionObj.categoryStepThree);ListingAutoActionObj.highlightBreadcrumbStep(2);};ListingAutoActionObj.loadCategoryChooser(callback);},categoryStepThree:function(){if(!EbayListingProductCategorySettingsChooserObj.validate()){return;}
ListingAutoActionObj.collectData();var mode=ListingAutoActionObj.getPopupMode();var callback=function(){ListingAutoActionObj.highlightBreadcrumbStep(3);$(mode+'confirm_button').show();$(mode+'reset_button').show();$(mode+'continue_button').hide();};ListingAutoActionObj.loadSpecific(callback);},collectData:function(){if($('auto_mode')){switch(parseInt($('auto_mode').value)){case M2ePro.php.constant('Ess_M2ePro_Model_Listing::AUTO_MODE_GLOBAL'):ListingAutoActionObj.internalData={auto_mode:$('auto_mode').value,auto_global_adding_mode:$('auto_global_adding_mode').value,auto_global_adding_add_not_visible:$('auto_global_adding_add_not_visible').value,auto_global_adding_template_category_id:null};break;case M2ePro.php.constant('Ess_M2ePro_Model_Listing::AUTO_MODE_WEBSITE'):ListingAutoActionObj.internalData={auto_mode:$('auto_mode').value,auto_website_adding_mode:$('auto_website_adding_mode').value,auto_website_adding_add_not_visible:$('auto_website_adding_add_not_visible').value,auto_website_adding_template_category_id:null,auto_website_deleting_mode:$('auto_website_deleting_mode').value};break;case M2ePro.php.constant('Ess_M2ePro_Model_Listing::AUTO_MODE_CATEGORY'):ListingAutoActionObj.internalData={id:$('group_id').value,title:$('group_title').value,auto_mode:$('auto_mode').value,adding_mode:$('adding_mode').value,adding_add_not_visible:$('adding_add_not_visible').value,deleting_mode:$('deleting_mode').value,categories:categories_selected_items};break;}}
