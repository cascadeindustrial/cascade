...
return value!='';},M2ePro.translator.translate('This is a required field.'));},initObservers:function(){jQuery('#country_mode').on('change',EbayTemplateShippingObj.countryModeChange).trigger('change');jQuery('#postal_code_mode').on('change',EbayTemplateShippingObj.postalCodeModeChange).trigger('change');jQuery('#address_mode').on('change',EbayTemplateShippingObj.addressModeChange).trigger('change');jQuery('#local_shipping_mode').on('change',EbayTemplateShippingObj.localShippingModeChange).trigger('change');if($('local_shipping_rate_table_mode')){jQuery('#local_shipping_rate_table_mode').on('change',EbayTemplateShippingObj.rateTableModeChange);}
...
jQuery('#international_shipping_mode').on('change',EbayTemplateShippingObj.internationalShippingModeChange).trigger('change');jQuery('.shipping_excluded_location_region_link').each(function(){jQuery(this).on('click',EbayTemplateShippingObj.checkExcludeLocationsRegionsSelection).on('mouseover',function(event){this.down('label').style.textDecoration='underline';}).on('mouseout',function(event){this.down('label').style.textDecoration='none';});});jQuery('.shipping_excluded_location').each(function(){jQuery(this).on('change',EbayTemplateShippingObj.selectExcludeLocation);});EbayTemplateShippingObj.renderShippingMethods(EbayTemplateShippingObj.shippingMethods);EbayTemplateShippingObj.checkMessages('local');EbayTemplateShippingObj.checkMessages('international');},countryModeChange:function(){var self=EbayTemplateShippingObj,elem=$('country_mode');if(elem.value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::COUNTRY_MODE_CUSTOM_VALUE')){self.updateHiddenValue(elem,$('country_custom_value'));}
if(elem.value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::COUNTRY_MODE_CUSTOM_ATTRIBUTE')){self.updateHiddenValue(elem,$('country_custom_attribute'));}},postalCodeModeChange:function(){var self=EbayTemplateShippingObj,elem=$('postal_code_mode');if(elem.value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::POSTAL_CODE_MODE_CUSTOM_VALUE')){$('postal_code_custom_value_tr').show();}else{$('postal_code_custom_value_tr').hide();}
if(elem.value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::POSTAL_CODE_MODE_CUSTOM_ATTRIBUTE')){self.updateHiddenValue(elem,$('postal_code_custom_attribute'));}},addressModeChange:function(){var self=EbayTemplateShippingObj,elem=$('address_mode');if(elem.value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::ADDRESS_MODE_CUSTOM_VALUE')){$('address_custom_value_tr').show();}else{$('address_custom_value_tr').hide();}
if(elem.value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::ADDRESS_MODE_CUSTOM_ATTRIBUTE')){self.updateHiddenValue(elem,$('address_custom_attribute'));}},dispatchTimeChange:function(){if(!$('click_and_collect_mode')){return;}
...
if(EbayTemplateShippingObj.isLocalShippingModeLocal()){$('international_shipping_mode').value=M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_NO_INTERNATIONAL');jQuery('#international_shipping_mode').trigger('change');$('magento_block_ebay_template_shipping_form_data_excluded_locations-wrapper').hide();EbayTemplateShippingObj.resetExcludeLocationsList();}},isLocalShippingModeFlat:function(){return $('local_shipping_mode').value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_FLAT');},isLocalShippingModeCalculated:function(){return $('local_shipping_mode').value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_CALCULATED');},isLocalShippingModeFreight:function(){return $('local_shipping_mode').value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_FREIGHT');},isLocalShippingModeLocal:function(){return $('local_shipping_mode').value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_LOCAL');},hasSurcharge:function(locationType){var marketplaceId=$$('[name="shipping[marketplace_id]"]')[0];return locationType=='local'&&marketplaceId&&['1','9'].indexOf(marketplaceId.value)!=-1;},internationalShippingModeChange:function(){$$('#shipping_international_tbody .icon-btn').each(function(el){EbayTemplateShippingObj.removeRow.call(el,'international');});if(EbayTemplateShippingObj.isInternationalShippingModeFlat()||EbayTemplateShippingObj.isInternationalShippingModeCalculated()){$('add_international_shipping_method_button').show();$('shipping_international_table').hide();$('international_shipping_methods_tr').show();$$('.international-shipping-tr').invoke('show');}else{$('international_shipping_methods_tr').hide();$$('.international-shipping-tr').invoke('hide');EbayTemplateShippingObj.deleteExcludedLocation('international','type','excluded_locations_hidden');EbayTemplateShippingObj.updateExcludedLocationsTitles('excluded_locations_titles');if($('international_shipping_rate_table_mode')){$('international_shipping_rate_table_mode').selectedIndex=0;jQuery('#international_shipping_rate_table_mode').trigger('change');}}
EbayTemplateShippingObj.updateMeasurementVisibility();EbayTemplateShippingObj.renderDiscountProfiles('international');EbayTemplateShippingObj.updateRateTableVisibility('international');EbayTemplateShippingObj.updateInternationalHandlingCostVisibility();EbayTemplateShippingObj.clearMessages('international');},isInternationalShippingModeFlat:function(){return $('international_shipping_mode').value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_FLAT');},isInternationalShippingModeCalculated:function(){return $('international_shipping_mode').value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_CALCULATED');},isInternationalShippingModeNoInternational:function(){return $('international_shipping_mode').value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_NO_INTERNATIONAL');},getCalculatedLocationType:function(){if(EbayTemplateShippingObj.isLocalShippingModeCalculated()){return'local';}
if(EbayTemplateShippingObj.isInternationalShippingModeCalculated()){return'international';}
return null;},isShippingModeCalculated:function(locationType){if(locationType=='local'){return EbayTemplateShippingObj.isLocalShippingModeCalculated();}
if(locationType=='international'){return EbayTemplateShippingObj.isInternationalShippingModeCalculated();}
return false;},isClickAndCollectEnabled:function(){if(!$('click_and_collect_mode')){return false;}
return $('click_and_collect_mode').value==1;},crossBorderTradeChange:function(){if(this.value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::CROSS_BORDER_TRADE_NONE')){$('international_shipping_none').show();}else{$('international_shipping_none').hide();if(EbayTemplateShippingObj.isInternationalShippingModeNoInternational()){$('international_shipping_mode').value=M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_FLAT');jQuery('#international_shipping_mode').trigger('change');}}},updateCrossBorderTradeVisibility:function(){if(!$('magento_block_ebay_template_shipping_form_data_cross_border_trade-wrapper')){return;}
if(EbayTemplateShippingObj.isLocalShippingModeFlat()||EbayTemplateShippingObj.isLocalShippingModeCalculated()){$('magento_block_ebay_template_shipping_form_data_cross_border_trade-wrapper').show();}else{$('magento_block_ebay_template_shipping_form_data_cross_border_trade-wrapper').hide();$('cross_border_trade').value=M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::CROSS_BORDER_TRADE_NONE');}},updateRateTableVisibility:function(locationType){var shippingMode=$(locationType+'_shipping_mode').value;if(!$(locationType+'_shipping_rate_table_mode_tr')){return;}
if(shippingMode!=M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_FLAT')){$(locationType+'_shipping_rate_table_mode_tr').hide();$(locationType+'_shipping_rate_table_mode').value=0;}else{$(locationType+'_shipping_rate_table_mode_tr').show();}},isRateTableEnabled:function(){var local=$('local_shipping_rate_table_mode'),international=$('international_shipping_rate_table_mode');if(!local&&!international){return false;}
return(local&&local.value!=0)||(international&&international.value!=0);},rateTableModeChange:function(){var absoluteHide=!!(!EbayTemplateShippingObj.isLocalShippingModeFlat()||EbayTemplateShippingObj.isRateTableEnabled());$$('[id^="shipping_variant_cost_surcharge_"]').each(function(surchargeRow){var row=surchargeRow.previous('tr');if(!row){return;}
var inputCostSurchargeCV=surchargeRow.select('.shipping-cost-surcharge')[0];var inputCostSurchargeCA=surchargeRow.select('.shipping-cost-surcharge-ca')[0];inputCostSurchargeCV.hide();inputCostSurchargeCA.hide();if(absoluteHide||!(/(FedEx|UPS)/.test(row.select('.shipping-service')[0].value))||row.select('.cost-mode')[0].value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Service::COST_MODE_FREE')){surchargeRow.hide();}else{surchargeRow.show();if(row.select('.cost-mode')[0].value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Service::COST_MODE_CUSTOM_VALUE')){inputCostSurchargeCV.show();inputCostSurchargeCV.disabled=false;}else if(row.select('.cost-mode')[0].value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Service::COST_MODE_CUSTOM_ATTRIBUTE')){inputCostSurchargeCA.show();}}});EbayTemplateShippingObj.updatePackageBlockState();},clickAndCollectModeChange:function(){EbayTemplateShippingObj.updatePackageBlockState();},updateLocalHandlingCostVisibility:function(){if(!$('local_handling_cost_cv_tr')){return;}
if(EbayTemplateShippingObj.isLocalShippingModeFlat()){$('local_handling_cost_cv_tr').hide();$('local_handling_cost').value='';}
if(EbayTemplateShippingObj.isLocalShippingModeCalculated()){$('local_handling_cost_cv_tr').show();}},updateInternationalHandlingCostVisibility:function(){if(!$('international_handling_cost_cv_tr')){return;}
if(EbayTemplateShippingObj.isInternationalShippingModeCalculated()){$('international_handling_cost_cv_tr').show();}else{$('international_handling_cost_cv_tr').hide();$('international_handling_cost').value='';}},updateDiscountProfiles:function(accountId){new Ajax.Request(M2ePro.url.get('ebay_template_shipping/updateDiscountProfiles'),{method:'get',parameters:{'account_id':accountId},onSuccess:function(transport){EbayTemplateShippingObj.discountProfiles[accountId]['profiles']=transport.responseText.evalJSON(true);EbayTemplateShippingObj.renderDiscountProfiles('local',accountId);EbayTemplateShippingObj.renderDiscountProfiles('international',accountId);}});},renderDiscountProfiles:function(locationType,renderAccountId){if(typeof renderAccountId=='undefined'){$$('.'+locationType+'-discount-profile-account-tr').each(function(account){var accountId=account.readAttribute('account_id');if($(locationType+'_shipping_discount_profile_id_'+accountId)){var value=EbayTemplateShippingObj.discountProfiles[accountId]['selected'][locationType];var html=EbayTemplateShippingObj.getDiscountProfilesHtml(locationType,accountId);$(locationType+'_shipping_discount_profile_id_'+accountId).update(html);if(value&&EbayTemplateShippingObj.discountProfiles[accountId]['profiles'].length>0){var select=$(locationType+'_shipping_discount_profile_id_'+accountId);for(var i=0;i<select.length;i++){if(select[i].value==value){select.value=value;break;}}}}});}else{if($(locationType+'_shipping_discount_profile_id_'+renderAccountId)){var value=EbayTemplateShippingObj.discountProfiles[renderAccountId]['selected'][locationType];var html=EbayTemplateShippingObj.getDiscountProfilesHtml(locationType,renderAccountId);$(locationType+'_shipping_discount_profile_id_'+renderAccountId).update(html);if(value&&EbayTemplateShippingObj.discountProfiles[renderAccountId]['profiles'].length>0){$(locationType+'_shipping_discount_profile_id_'+renderAccountId).value=value;}}}},getDiscountProfilesHtml:function(locationType,accountId){var shippingModeSelect=$(locationType+'_shipping_mode');var desiredProfileType=null;var html='<option value="">'+M2ePro.translator.translate('None')+'</option>';switch(parseInt(shippingModeSelect.value)){case M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_FLAT'):desiredProfileType='flat_shipping';break;case M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping::SHIPPING_TYPE_CALCULATED'):desiredProfileType='calculated_shipping';break;}
...
html+='<option value="'+profile.profile_id+'">'+profile.profile_name+'</option>';});return html;},updateCashOnDeliveryCostVisibility:function(){if(!$('cash_on_delivery_cost_cv_tr')){return;}
if(EbayTemplateShippingObj.isLocalShippingModeFlat()||EbayTemplateShippingObj.isLocalShippingModeCalculated()){$('cash_on_delivery_cost_cv_tr').show();}else{$('cash_on_delivery_cost_cv_tr').hide();$('cash_on_delivery_cost').value='';}},packageSizeChange:function(){var self=EbayTemplateShippingObj;var packageSizeMode=this.value;$('package_size_mode').value=packageSizeMode;$('package_size_attribute').value='';if(packageSizeMode==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Calculated::PACKAGE_SIZE_CUSTOM_VALUE')){self.updateHiddenValue(this,$('package_size_value'));var showDimension=parseInt(this.options[this.selectedIndex].getAttribute('dimensions_supported'));self.updateDimensionVisibility(showDimension);}else if(packageSizeMode==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Calculated::PACKAGE_SIZE_CUSTOM_ATTRIBUTE')){self.updateHiddenValue(this,$('package_size_attribute'));self.updateDimensionVisibility(true);}},updateDimensionVisibility:function(showDimension){if(showDimension){$('dimensions_tr').show();jQuery('#dimension_mode').trigger('change');}else{$('dimensions_tr').hide();$('dimension_mode').value=0;jQuery('#dimension_mode').trigger('change');}},dimensionModeChange:function(){$$('.dimensions_ca_tr, .dimensions_cv_tr').invoke('hide');if(this.value!=0){$$(this.value==1?'.dimensions_cv_tr':'.dimensions_ca_tr').invoke('show');}},weightChange:function(){var measurementNoteElement=this.up().next('.note');$('weight_cv').hide();measurementNoteElement.hide();var weightMode=this.value;$('weight_mode').value=weightMode;$('weight_attribute').value='';if(weightMode==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Calculated::WEIGHT_CUSTOM_VALUE')){$('weight_cv').show();}else if(weightMode==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Calculated::WEIGHT_CUSTOM_ATTRIBUTE')){EbayTemplateShippingObj.updateHiddenValue(this,$('weight_attribute'));measurementNoteElement.show();}},isMeasurementSystemEnglish:function(){return $('measurement_system').value==M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Calculated::MEASUREMENT_SYSTEM_ENGLISH');},measurementSystemChange:function(){$$('.measurement-system-english, .measurement-system-metric').invoke('hide');if(EbayTemplateShippingObj.isMeasurementSystemEnglish()){$$('.measurement-system-english').invoke('show');}else{$$('.measurement-system-metric').invoke('show');}},updateMeasurementVisibility:function(){if(EbayTemplateShippingObj.isLocalShippingModeCalculated()){EbayTemplateShippingObj.showMeasurementOptions('local','calculated');EbayTemplateShippingObj.updatePackageBlockState();return;}
...
EbayTemplateShippingObj.updatePackageBlockState();},showMeasurementOptions:function(locationType,shippingMode){$$('#block_shipping_template_calculated_options tr').each(function(element){if(element.hasClassName('visible-for-'+shippingMode+'-by-default')){element.show();}else{element.hide();}});EbayTemplateShippingObj.prepareMeasurementObservers(shippingMode);},prepareMeasurementObservers:function(shippingMode){jQuery('#measurement_system').on('change',EbayTemplateShippingObj.measurementSystemChange).trigger('change');if(shippingMode=='calculated'){jQuery('#package_size').on('change',EbayTemplateShippingObj.packageSizeChange).trigger('change');}
if($('dimension_mode')){jQuery('#dimension_mode').on('change',EbayTemplateShippingObj.dimensionModeChange).trigger('change');}
jQuery('#weight').on('change',EbayTemplateShippingObj.weightChange).trigger('change');},serviceChange:function(){var row=$(this).up('tr');if(this.up('table').id!='shipping_international_table'){this.down(0).hide();}
if(this.value===''){row.select('.cost-mode')[0].hide();row.select('.shipping-cost-cv')[0].hide();row.select('.shipping-cost-ca')[0].hide();row.select('.shipping-cost-additional')[0].hide();row.select('.shipping-cost-additional-ca')[0].hide();}else{row.select('.cost-mode')[0].show();jQuery(row.select('.cost-mode')[0]).trigger('change');}},serviceCostModeChange:function(){var row=$(this).up('tr');var surchargeRow=$('shipping_variant_cost_surcharge_'+this.name.match(/\d+/)+'_tr');if(EbayTemplateShippingObj.isLocalShippingModeFlat()&&surchargeRow){var inputCostSurchargeCV=surchargeRow.select('.shipping-cost-surcharge')[0];var inputCostSurchargeCA=surchargeRow.select('.shipping-cost-surcharge-ca')[0];if(!EbayTemplateShippingObj.isRateTableEnabled()&&/(FedEx|UPS)/.test(row.select('.shipping-service')[0].value)){surchargeRow.show();}else{surchargeRow.hide();}}
...
return row;},initRow:function(row){var locationType=/local/.test(row.id)?'local':'international';if(EbayTemplateShippingObj.isShippingModeCalculated(locationType)){row.select('.cost-mode')[0].value=M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Service::COST_MODE_CALCULATED');row.select('.shipping-mode-option-notcalc').invoke('remove');if(locationType=='international'||$$('#shipping_local_tbody .cost-mode').length>1){row.select('.shipping-mode-option-free').invoke('remove');}}else{row.select('.cost-mode')[0].value=M2ePro.php.constant('\\Ess\\M2ePro\\Model\\Ebay\\Template\\Shipping\\Service::COST_MODE_FREE');row.select('.shipping-mode-option-calc')[0].remove();}
EbayTemplateShippingObj.renderServices(row.select('.shipping-service')[0],locationType);jQuery(row.select('.cost-mode')[0]).trigger('change');jQuery(row.select('.shipping-service')[0]).trigger('change');},renderServices:function(el,locationType){var html='';var isCalculated=EbayTemplateShippingObj.isShippingModeCalculated(locationType);var selectedPackage=$('package_size_value').value;var categoryMethods='';if(locationType=='international'){html+='<option value="">--</option>';}else{html+='<option value="">'+M2ePro.translator.translate('Select Shipping Service')+'</option>';}
...
jQuery(el).trigger('change');});$$('input[value="Worldwide"]').each(function(element){EbayTemplateShippingObj.shippingLocationChange.call(element);});},removeRow:function(locationType){var table=$(this).up('table');if(locationType=='international'){$(this).up('tr').next().remove();}
...
EbayTemplateShippingObj.updateMeasurementVisibility();},hasMissingServiceAttribute:function(code,position){if(typeof EbayTemplateShippingObj.missingAttributes['services'][position]=='undefined'){return false;}
if(typeof EbayTemplateShippingObj.missingAttributes['services'][position][code]=='undefined'){return false;}
return true;},addMissingServiceAttributeOption:function(select,code,position,value){var option=document.createElement('option');option.value=value;option.innerHTML=EbayTemplateShippingObj.missingAttributes['services'][position][code];var first=select.down('.empty').next();first.insert({before:option});},renderShippingMethods:function(shippingMethods){if(shippingMethods.length>0){$('shipping_local_table').show();$('add_local_shipping_method_button').hide();}else{$('shipping_local_table').hide();$('add_local_shipping_method_button').show();}
...
row.down('.shipping-priority').value=service.priority;jQuery(row.down('.cost-mode')).trigger('change');jQuery(row.down('.shipping-service')).trigger('change');});},replaceSelectWithInputHidden:function(select){var td=select.up('td');var label=select.options[select.selectedIndex].innerHTML;var input='<input type="hidden" '+'name="'+select.name+'" '+'id="'+select.id+'" '+'value="'+select.value+'" '+'class="'+select.className+'" />';$(select).replace('');$(td).insert('<span>'+label+input+'</span>');if(td.down('.cost-mode')){td.down('.cost-mode').observe('change',EbayTemplateShippingObj.serviceCostModeChange);}},initExcludeListPopup:function(){var element=jQuery('#magento_block_ebay_template_shipping_form_data_exclude_locations_popup');modal({title:M2ePro.translator.translate('Excluded Shipping Locations'),type:'slide',buttons:[{text:M2ePro.translator.translate('Cancel'),click:function(){element.modal('closeModal');}},{text:M2ePro.translator.translate('Save'),class:'action-primary',id:'save_popup_button',click:function(){EbayTemplateShippingObj.saveExcludeLocationsList();element.modal('closeModal');}}]},element);},showExcludeListPopup:function(){var self=EbayTemplateShippingObj;self.updatePopupData();self.checkExcludeLocationSelection();self.afterInitPopupActions();jQuery('#magento_block_ebay_template_shipping_form_data_exclude_locations_popup').modal('openModal');},updatePopupData:function(){$('excluded_locations_popup_hidden').value=$('excluded_locations_hidden').value;EbayTemplateShippingObj.updateExcludedLocationsTitles();},checkExcludeLocationSelection:function(){var self=EbayTemplateShippingObj,excludedLocations=$('excluded_locations_popup_hidden').value.evalJSON();$$('.shipping_excluded_location').each(function(el){el.checked=0;});$$('.shipping_excluded_location').each(function(el){for(var i=0;i<excludedLocations.length;i++){if(excludedLocations[i]['code']==el.value){el.checked=1;el.hasClassName('shipping_excluded_region')&&self.selectExcludedLocationAllRegion(el.value,1);}}});EbayTemplateShippingObj.updateExcludedLocationsSelectedRegions();},selectExcludedLocationAllRegion:function(regionCode,checkBoxState){$$('div[id="shipping_excluded_location_international_region_'+regionCode+'"] .shipping_excluded_location').each(function(el){el.checked=checkBoxState;});},afterInitPopupActions:function(){var firstNavigationLink=$$('.shipping_excluded_location_region_link').shift();firstNavigationLink&&jQuery(firstNavigationLink).trigger('click');EbayTemplateShippingObj.isInternationalShippingModeNoInternational()?$('exclude_locations_popup_international').hide():$('exclude_locations_popup_international').show();EbayTemplateShippingObj.updatePopupSizes();},updatePopupSizes:function(){var popupHeight='445px',popupGeneralContentMinHeight='380px';if(EbayTemplateShippingObj.isInternationalShippingModeNoInternational()){popupHeight='280px';popupGeneralContentMinHeight='200px';}
$('excluded_locations_popup_content_general').setStyle({'min-height':popupGeneralContentMinHeight});if($('exclude_locations_international_regions')){var standartRegionHeight=$('exclude_locations_international_regions').getHeight();$('exclude_locations_international_locations').setStyle({'height':standartRegionHeight+'px'});}},saveExcludeLocationsList:function(){var title=$('excluded_locations_popup_titles').innerHTML,titleContainer=$('excluded_locations_titles');title==M2ePro.translator.translate('None')?titleContainer.innerHTML=M2ePro.translator.translate('No Locations are currently excluded.'):titleContainer.innerHTML=title;$('excluded_locations_hidden').value=$('excluded_locations_popup_hidden').value;},resetExcludeLocationsList:function(window){window=window||'general';if(window=='general'){$('excluded_locations_hidden').value='[]';$('excluded_locations_titles').innerHTML=M2ePro.translator.translate('No Locations are currently excluded.');return;}
$('excluded_locations_popup_hidden').value='[]';EbayTemplateShippingObj.updateExcludedLocationsTitles();EbayTemplateShippingObj.checkExcludeLocationSelection();},selectExcludeLocation:function(){EbayTemplateShippingObj.updateExcludedLocationsHiddenInput(this);EbayTemplateShippingObj.updateExcludedLocationsTitles();EbayTemplateShippingObj.updateExcludedLocationsSelectedRegions();},updateExcludedLocationsHiddenInput:function(element){var self=EbayTemplateShippingObj,asia=$('shipping_excluded_location_international_Asia');if(element.hasClassName('shipping_excluded_region')){element.checked?self.processRegionWasSelected(element):self.processRegionWasDeselected(element);self.processRelatedRegions(element);}else{element.checked?self.processOneLocationWasSelected(element):self.processOneLocationWasDeselected(element);if(self.isChildAsiaRegion(element.getAttribute('region'))){self.processAsiaChildRegion(element);}}
if(self.isAllLocationsOfAsiaAreSelected()&&!asia.checked){asia.checked=1;self.processRegionWasSelected($(asia));}},processRegionWasSelected:function(regionCheckBox){var self=EbayTemplateShippingObj,code=regionCheckBox.value,title=regionCheckBox.next().innerHTML,region=regionCheckBox.getAttribute('region'),type=regionCheckBox.getAttribute('location_type');self.selectExcludedLocationAllRegion(code,1);self.deleteExcludedLocation(code,'region');self.addExcludedLocation(code,title,region,type);},processRegionWasDeselected:function(regionCheckBox){var self=EbayTemplateShippingObj,code=regionCheckBox.value;self.selectExcludedLocationAllRegion(code,0);self.deleteExcludedLocation(code);},processRelatedRegions:function(regionCheckBox){var self=EbayTemplateShippingObj;if(self.isAsiaRegion(regionCheckBox.value)){self.processAsiaRegion(regionCheckBox);}
if(self.isChildAsiaRegion(regionCheckBox.value)){self.processAsiaChildRegion(regionCheckBox);}},processAsiaRegion:function(regionCheckBox){var self=EbayTemplateShippingObj;var middleEast=$('shipping_excluded_location_international_Middle East'),southeastAsia=$('shipping_excluded_location_international_Southeast Asia');if(regionCheckBox.checked){if(!middleEast.checked){middleEast.checked=1;self.processRegionWasSelected(middleEast);}
if(!southeastAsia.checked){southeastAsia.checked=1;self.processRegionWasSelected(southeastAsia);}
return;}
middleEast.checked=0;southeastAsia.checked=0;self.processRegionWasDeselected(middleEast);self.processRegionWasDeselected(southeastAsia);},processAsiaChildRegion:function(regionCheckBox){var self=EbayTemplateShippingObj,asia=$('shipping_excluded_location_international_Asia');if(!regionCheckBox.checked&&asia.checked){var code=asia.value;asia.checked=0;self.deleteExcludedLocation(code,'code');$$('div[id="shipping_excluded_location_international_region_'+code+'"] .shipping_excluded_location').each(function(el){el.checked=1;self.addExcludedLocation(el.value,el.next().innerHTML,el.getAttribute('region'),el.getAttribute('type'));});}},processOneLocationWasSelected:function(locationCheckBox){var self=EbayTemplateShippingObj,code=locationCheckBox.value,title=locationCheckBox.next().innerHTML,region=locationCheckBox.getAttribute('region'),type=locationCheckBox.getAttribute('location_type');self.addExcludedLocation(code,title,region,type);if(!self.isAllLocationsOfRegionAreSelected(region)){return;}
if(self.isAsiaRegion(region)&&!self.isAllLocationsOfAsiaAreSelected()){return;}
var regionTitle=$('shipping_excluded_location_international_'+region).next('label').innerHTML;$('shipping_excluded_location_international_'+region).checked=1;self.deleteExcludedLocation(region,'region');self.addExcludedLocation(region,regionTitle,null,type);},processOneLocationWasDeselected:function(locationCheckBox){var self=EbayTemplateShippingObj,code=locationCheckBox.value,region=locationCheckBox.getAttribute('region'),type=locationCheckBox.getAttribute('location_type');self.deleteExcludedLocation(code);if(region==null){return;}
self.deleteExcludedLocation(region);self.deleteExcludedLocation(region,'region');$('shipping_excluded_location_international_'+region).checked=0;var result=self.getLocationsByRegion(region);result['locations'].each(function(el){self.addExcludedLocation(el.value,el.next().innerHTML,region,type);});},updateExcludedLocationsTitles:function(sourse){sourse=sourse||'excluded_locations_popup_titles';var excludedLocations=$(sourse.replace('titles','hidden')).value.evalJSON(),title=sourse=='excluded_locations_popup_titles'?M2ePro.translator.translate('None'):M2ePro.translator.translate('No Locations are currently excluded.');if(excludedLocations.length){title=[];excludedLocations.each(function(location){var currentTitle=EbayTemplateShippingObj.isRootLocation(location)?'<b>'+location['title']+'</b>':location['title'];title.push(currentTitle);});title=title.join(', ');}
...
$(sourse).innerHTML=title;},updateExcludedLocationsSelectedRegions:function(){$$('.shipping_excluded_location_region_link').each(function(el){var locations=EbayTemplateShippingObj.getLocationsByRegion(el.getAttribute('region'));el.removeClassName('have_selected_locations');if(locations['selected']>0&&!el.children[0].checked){el.addClassName('have_selected_locations');el.down('span',1).innerHTML='('+locations['selected']+' '+M2ePro.translator.translate('selected')+')';}});},getLocationsByRegion:function(regionCode){if(regionCode==null){return false;}
var totalCount=0,selectedLocations=[];$$('div[id="shipping_excluded_location_international_region_'+regionCode+'"] .shipping_excluded_location').each(function(el){totalCount++;el.checked&&selectedLocations.push(el);});return{total:totalCount,selected:selectedLocations.length,locations:selectedLocations};},isAllLocationsOfRegionAreSelected:function(regionCode){var locations=EbayTemplateShippingObj.getLocationsByRegion(regionCode);if(!locations){return false;}
return locations['total']==locations['selected'];},isAllLocationsOfAsiaAreSelected:function(){var asiaLocations=EbayTemplateShippingObj.getLocationsByRegion('Asia'),eastLocations=EbayTemplateShippingObj.getLocationsByRegion('Middle East'),southLocations=EbayTemplateShippingObj.getLocationsByRegion('Southeast Asia');if(!asiaLocations||!eastLocations||!southLocations){return false;}
return asiaLocations['total']==asiaLocations['selected']&&eastLocations['total']==eastLocations['selected']&&southLocations['total']==southLocations['selected'];},isRootLocation:function(location){return!!(location['region']==null);},isAsiaRegion:function(location){return location=='Asia';},isChildAsiaRegion:function(location){return location=='Middle East'||location=='Southeast Asia';},addExcludedLocation:function(code,title,region,type,sourse){sourse=sourse||'excluded_locations_popup_hidden';var excludedLocations=$(sourse).value.evalJSON();var item={code:code,title:title,region:region,type:type};excludedLocations.push(item);$(sourse).value=Object.toJSON(excludedLocations);},deleteExcludedLocation:function(code,key,sourse){key=key||'code';sourse=sourse||'excluded_locations_popup_hidden';var excludedLocations=$(sourse).value.evalJSON(),resultAfterDelete=[];for(var i=0;i<excludedLocations.length;i++){if(excludedLocations[i][key]!=code){resultAfterDelete.push(excludedLocations[i]);}}
$(sourse).value=Object.toJSON(resultAfterDelete);},checkExcludeLocationsRegionsSelection:function(){$$('.shipping_excluded_location_region').invoke('hide');$$('.shipping_excluded_location_region_link').invoke('removeClassName','selected_region');$('shipping_excluded_location_international_region_'+this.getAttribute('region')).show();this.addClassName('selected_region');},updatePackageBlockState:function(){if(this.isLocalShippingModeCalculated()||this.isInternationalShippingModeCalculated()){this.setCalculatedPackageBlockState();return;}
...
this.setNonePackageBlockState();},setCalculatedPackageBlockState:function(){$('magento_block_ebay_template_shipping_form_data_calculated-wrapper').show();var dimensionsTr=$('dimensions_tr');var dimensionSelect=$('dimension_mode');if(dimensionsTr){dimensionsTr.show();jQuery(dimensionSelect).trigger('change');}
...
weightTr.show();$('weight_mode_none').hide();jQuery(weightSelect).trigger('change');}},setRateTablePackageBlockState:function(){$('magento_block_ebay_template_shipping_form_data_calculated-wrapper').show();var dimensionsTr=$('dimensions_tr');var dimensionSelect=$('dimension_mode');if(dimensionsTr){dimensionsTr.hide();dimensionSelect.selectedIndex=0;jQuery(dimensionSelect).trigger('change');}
...
var weightTr=$('weight_tr');var weightSelect=$('weight');if(weightTr){weightTr.show();$('weight_mode_none').show();jQuery(weightSelect).trigger('change');}},setClickAndCollectPackageBlockState:function(){$('magento_block_ebay_template_shipping_form_data_calculated-wrapper').show();var dimensionsTr=$('dimensions_tr');var dimensionSelect=$('dimension_mode');if(dimensionsTr){dimensionsTr.show();jQuery(dimensionSelect).trigger('change');}
var packageSizeTr=$('package_size_tr');var packageSizeSelect=$('package_size');if(packageSizeTr){packageSizeTr.hide();packageSizeSelect.selectedIndex=0;jQuery(packageSizeSelect).trigger('change');}
var weightTr=$('weight_tr');var weightSelect=$('weight');if(weightTr){weightTr.show();$('weight_mode_none').show();jQuery(weightSelect).trigger('change');}},setNonePackageBlockState:function(){$('magento_block_ebay_template_shipping_form_data_calculated-wrapper').hide();var dimensionsTr=$('dimensions_tr');var dimensionSelect=$('dimension_mode');if(dimensionsTr){dimensionSelect.selectedIndex=0;jQuery(dimensionSelect).trigger('change');}
var weightTr=$('weight_tr');var weightSelect=$('weight');if(weightTr){weightSelect.selectedIndex=0;jQuery(weightSelect).trigger('change');}},checkMessages:function(type){if(typeof EbayListingTemplateSwitcherObj=='undefined'){return;}
