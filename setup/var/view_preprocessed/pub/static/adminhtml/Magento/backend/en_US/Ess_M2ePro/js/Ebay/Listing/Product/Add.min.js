...
this.autoactionPopup.modal('openModal');}.bind(this)});},cancelAutoActionPopup:function(){ListingProductAddObj.autoactionPopup.modal('closeModal');ListingProductAddObj.continue();}});});