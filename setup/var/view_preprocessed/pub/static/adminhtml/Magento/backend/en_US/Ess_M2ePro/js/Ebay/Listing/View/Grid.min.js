define(['M2ePro/Listing/View/Grid','M2ePro/Ebay/Listing/VariationProductManage','M2ePro/Ebay/Listing/View/Action','M2ePro/Ebay/Listing/View/Ebay/Bids'],function(){window.EbayListingViewGrid=Class.create(ListingViewGrid,{selectedProductsIds:[],selectedCategoriesData:{},prepareActions:function($super){this.actionHandler=new EbayListingViewAction(this);this.actions={listAction:this.actionHandler.listAction.bind(this.actionHandler),relistAction:this.actionHandler.relistAction.bind(this.actionHandler),reviseAction:this.actionHandler.reviseAction.bind(this.actionHandler),stopAction:this.actionHandler.stopAction.bind(this.actionHandler),stopAndRemoveAction:this.actionHandler.stopAndRemoveAction.bind(this.actionHandler),previewItemsAction:this.actionHandler.previewItemsAction.bind(this.actionHandler),startTranslateAction:this.actionHandler.startTranslateAction.bind(this.actionHandler),stopTranslateAction:this.actionHandler.stopTranslateAction.bind(this.actionHandler)};this.variationProductManageHandler=new EbayListingVariationProductManage(this);this.listingProductBidsHandler=new EbayListingViewEbayBids(this);this.actions=Object.extend(this.actions,{editCategorySettingsAction:function(id){this.editCategorySettings(id);}.bind(this)});},massActionSubmitClick:function($super){if(this.getSelectedProductsString()==''||this.getSelectedProductsArray().length==0){this.alert(M2ePro.translator.translate('Please select the Products you want to perform the Action on.'));return;}
$super();},editCategorySettings:function(id){this.selectedProductsIds=id?[id]:this.getSelectedProductsArray();new Ajax.Request(M2ePro.url.get('ebay_listing/getCategoryChooserHtml'),{method:'post',asynchronous:true,parameters:{product_ids:this.selectedProductsIds.join(',')},onSuccess:function(transport){this.unselectAll();var title=M2ePro.translator.translate('eBay Categories');if(this.selectedProductsIds.length==1){var productName=this.getProductNameByRowId(this.selectedProductsIds[0]);title+='&nbsp;'+M2ePro.translator.translate('of Product')+'&nbsp;"'+productName+'"';}
