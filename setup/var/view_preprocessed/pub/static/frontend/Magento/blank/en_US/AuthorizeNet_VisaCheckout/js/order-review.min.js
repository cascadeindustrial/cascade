...
this._ajaxComplete();alert({content:$.mage.__('Sorry, something went wrong.')});}},error:function(){alert({content:$.mage.__('Sorry, something went wrong. Please try again later.')});this._ajaxComplete();}});},_validateForm:function(){this.element.find(this.options.agreementSelector).off('change').on('change',$.proxy(function(){var isValid=this._validateForm();this._updateOrderSubmit(!isValid);},this));var valid=true;if($(this.options.shippingAddressFromSelector).length){valid=$(this.options.shippingAddressFromSelector).valid()&&valid;}
if($(this.options.billingAddressFromSelector).length){valid=$(this.options.billingAddressFromSelector).valid()&&valid;}
if(this.element.data('mageValidation')){return this.element.validation().valid()&&valid;}
