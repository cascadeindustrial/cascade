...
/**
 * Class QuoteFollowUpSender
 *
 * @package Cart2Quote/Quotation/Model/Quote/Email/Sender
 */
class QuoteFollowUpSender extends Sender
{
    use \Cart2Quote\Features\Traits\Model\Quote\Email\Sender\QuoteFollowUpSender {
    }

    /**
     * QuoteFollowUpSender constructor.
     *
