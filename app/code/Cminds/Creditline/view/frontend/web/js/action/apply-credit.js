define([
    ...
    'Cminds_Creditline/js/model/payment/messages',
    'mage/storage',
    ...
    return function (apply, isLoading) {
        ...
        if (apply) {
            ...
            if (!Number.isNaN(Number.parseFloat(value))) {
                creditAmount = Number.parseFloat(value).toFixed(4);
            }
            ...
            url = urlBuilder.createUrl('/carts/mine/creditline/apply/:creditAmount', {creditAmount: creditAmount});
            message = $t('Store credit was successfully applied');
        } else {
            url = urlBuilder.createUrl('/carts/mine/creditline/cancel/:creditAmount', {creditAmount: creditAmount});
