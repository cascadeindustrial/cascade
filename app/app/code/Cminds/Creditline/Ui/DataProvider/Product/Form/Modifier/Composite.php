...
namespace Cminds\Creditline\Ui\DataProvider\Product\Form\Modifier;

use Cminds\Creditline\Model\ProductOptionCreditFactory;
use Cminds\Creditline\Model\Product\Type as CreditType;
...
class Composite extends AbstractModifier
{
    ...
    const CREDIT_PRICE_BLOCK = 'creditline_price_block';

    const FIELD_ENABLE           = 'affect_product_creditline_prices';
    const FIELD_PRICE_NAME       = 'price';
    const FIELD_PRICE_TYPE_NAME  = 'price_type_name';
    const FIELD_SORT_ORDER_NAME  = 'sort_order';
    const FIELD_OPTION_ID        = 'option_id';
    const FIELD_TYPE_NAME        = 'creditline_price_type';
    ...
    const PRICE_OPTION = 'creditline_price_options';
    ...
    /**
     * @param ProductOptionCredit $options
     * @return array
     */
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component'            => 'Cminds_Creditline/js/product-price-options-type',
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'template'            => 'Cminds_Creditline/dynamic-rows/templates/option',
