...
return [
    'modules' => [
        ...
        'Batao_FillQuoteCheckout' => 1,
        'Bitpolar_SortCatalogWidget' => 1,
        'Bss_DeleteOrder' => 1,
        'Cart2Quote_Quotation' => 1,
        'Cart2Quote_Features' => 0,
        'Cart2Quote_License' => 0,
        'Cart2Quote_AmastyCompatability' => 1,
        'Cminds_Creditline' => 1,
        'CompactCode_Base' => 0,
        'CompactCode_MessagePopUp' => 0,
        'Dcw_Brands' => 0,
        'Dcw_ConfigOptions' => 0,
        'Dcw_CreditForm' => 0,
        'Dcw_CustomPricing' => 0,
        'Dcw_CustomRequestForm' => 1,
        'Dcw_CustomShippingMethod' => 0,
        'Dcw_Customer' => 1,
        'Dcw_DisablePaymentMethod' => 0,
        'Dcw_Downloads' => 0,
        'Dcw_FeaturedProducts' => 1,
        'Dcw_FileUpload' => 1,
        'Dcw_HeaderDesign' => 1,
        'Dcw_MegaMenu' => 1,
        'Dcw_Override' => 1,
        'Dcw_PaymentMethod' => 0,
        'Dcw_Products' => 1,
        'Dcw_ShippingAccount' => 0,
        'Dcw_ShippingMethod' => 0,
        'Dcw_Shippingdescription' => 0,
        'Dcw_SimpleSku' => 1,
        'Dcw_TopCategories' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Elgentos_LargeConfigProducts' => 1,
        'Ess_M2ePro' => 0,
        'Klarna_Core' => 1,
        'Klarna_Ordermanagement' => 1,
        'Klarna_Kp' => 1,
        'MSP_Common' => 0,
        'MSP_CmsImportExport' => 0,
        'Magento_PaypalReCaptcha' => 1,
        'MSP_TwoFactorAuth' => 0,
        'MageMaclean_Core' => 1,
        'MageMaclean_MyShipping' => 1,
        'MageMaclean_MyShippingCustomer' => 1,
        'MageWorx_GeoIP' => 1,
        ...
        'MageWorx_StoreSwitcher' => 1,
        'MageWorx_XmlSitemap' => 1,
        'Magebees_MPM' => 0,
        'Magefan_Community' => 0,
        'Magefan_GuestToCustomer' => 0,
        'Mageplaza_Core' => 1,
        'Mageplaza_Blog' => 1,
        'Mageplaza_BackendReindex' => 1,
        'Mageplaza_LoginAsCustomer' => 1,
        'Magezon_Core' => 0,
        'Magezon_CustomerAttachments' => 0,
        'Magezon_TabGrid' => 0,
