...
class Interceptor extends \MageWorx\XmlSitemap\Console\Command\XmlSitemapGenerateCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAvailableIds');
        if (!$pluginInfo) {
            return parent::getAvailableIds();
        } else {
            return $this->___callPlugins('getAvailableIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getColumnsValues');
        if (!$pluginInfo) {
            return parent::getColumnsValues();
        } else {
            return $this->___callPlugins('getColumnsValues', func_get_args(), $pluginInfo);
        }
    }
