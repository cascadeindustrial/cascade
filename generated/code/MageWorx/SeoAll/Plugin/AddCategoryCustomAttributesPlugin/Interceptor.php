...
class Interceptor extends \MageWorx\SeoAll\Plugin\AddCategoryCustomAttributesPlugin implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'afterPrepareMeta');
        if (!$pluginInfo) {
            return parent::afterPrepareMeta($subject, $result);
        } else {
            return $this->___callPlugins('afterPrepareMeta', func_get_args(), $pluginInfo);
        }
    }
