<?php
namespace Aitoc\ConfigurableProducts\Block\Easyconf;

/**
 * Interceptor class for @see \Aitoc\ConfigurableProducts\Block\Easyconf
 */
class Interceptor extends \Aitoc\ConfigurableProducts\Block\Easyconf implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Aitoc\ConfigurableProducts\Helper\Data $helper, \Aitoc\ConfigurableProducts\Model\TemporaryFactory $temporaryFactory, \Aitoc\ConfigurableProducts\Model\Config $config, \Magento\Framework\Registry $registry, \Magento\CatalogInventory\Model\Configuration $cataloginventoryConfig, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $helper, $temporaryFactory, $config, $registry, $cataloginventoryConfig, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUsedProductsIds');
        if (!$pluginInfo) {
            return parent::getUsedProductsIds();
        } else {
            return $this->___callPlugins('getUsedProductsIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUsedProductsCount');
        if (!$pluginInfo) {
            return parent::getUsedProductsCount();
        } else {
            return $this->___callPlugins('getUsedProductsCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getControllerUrl');
        if (!$pluginInfo) {
            return parent::getControllerUrl();
        } else {
            return $this->___callPlugins('getControllerUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSimpleProductHtml');
        if (!$pluginInfo) {
            return parent::getSimpleProductHtml($id);
        } else {
            return $this->___callPlugins('getSimpleProductHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRestoreHtml');
        if (!$pluginInfo) {
            return parent::getRestoreHtml();
        } else {
            return $this->___callPlugins('getRestoreHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getHelper');
        if (!$pluginInfo) {
            return parent::_getHelper();
        } else {
            return $this->___callPlugins('_getHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsLimit');
        if (!$pluginInfo) {
            return parent::getProductsLimit();
        } else {
            return $this->___callPlugins('getProductsLimit', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductStatusOptions');
        if (!$pluginInfo) {
            return parent::getProductStatusOptions();
        } else {
            return $this->___callPlugins('getProductStatusOptions', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getBackorderOption()
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBackorderOption');
        if (!$pluginInfo) {
            return parent::getBackorderOption();
        } else {
            return $this->___callPlugins('getBackorderOption', func_get_args(), $pluginInfo);
        }
    }
