<?php
namespace Aitoc\ConfigurableProducts\Block\Restore;

/**
 * Interceptor class for @see \Aitoc\ConfigurableProducts\Block\Restore
 */
class Interceptor extends \Aitoc\ConfigurableProducts\Block\Restore implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Aitoc\ConfigurableProducts\Helper\Data $helper, \Aitoc\ConfigurableProducts\Model\TemporaryFactory $temporaryFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $helper, $temporaryFactory, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDetected');
        if (!$pluginInfo) {
            return parent::getDetected();
        } else {
            return $this->___callPlugins('getDetected', func_get_args(), $pluginInfo);
        }
    }
