<?php
namespace Aitoc\ConfigurableProducts\Model\Rewrite\ResourceModel\Product;

/**
 * Interceptor class for @see \Aitoc\ConfigurableProducts\Model\Rewrite\ResourceModel\Product
 */
class Interceptor extends \Aitoc\ConfigurableProducts\Model\Rewrite\ResourceModel\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'linkSimpleToConfigurable');
        if (!$pluginInfo) {
            return parent::linkSimpleToConfigurable($configurableId, $simpleId);
        } else {
            return $this->___callPlugins('linkSimpleToConfigurable', func_get_args(), $pluginInfo);
        }
    }
