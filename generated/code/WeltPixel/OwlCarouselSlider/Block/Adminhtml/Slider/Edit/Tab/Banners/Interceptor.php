...
class Interceptor extends \WeltPixel\OwlCarouselSlider\Block\Adminhtml\Slider\Edit\Tab\Banners implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectedSliderBanners');
        if (!$pluginInfo) {
            return parent::getSelectedSliderBanners();
        } else {
            return $this->___callPlugins('getSelectedSliderBanners', func_get_args(), $pluginInfo);
        }
    }
