...
class Interceptor extends \WeltPixel\OwlCarouselSlider\Block\Adminhtml\Slider\Edit\Tab\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDependencyField');
        if (!$pluginInfo) {
            return parent::getDependencyField($refField, $negative, $separator, $fieldPrefix);
        } else {
            return $this->___callPlugins('getDependencyField', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMappingFieldDependence');
        if (!$pluginInfo) {
            return parent::getMappingFieldDependence();
        } else {
            return $this->___callPlugins('getMappingFieldDependence', func_get_args(), $pluginInfo);
        }
    }
