...
class Interceptor extends \WeltPixel\OwlCarouselSlider\Block\Adminhtml\Banner\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderAvailableOption');
        if (!$pluginInfo) {
            return parent::getSliderAvailableOption();
        } else {
            return $this->___callPlugins('getSliderAvailableOption', func_get_args(), $pluginInfo);
        }
    }
