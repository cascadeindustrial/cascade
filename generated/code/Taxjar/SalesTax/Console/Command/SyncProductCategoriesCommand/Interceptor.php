<?php
namespace Taxjar\SalesTax\Console\Command\SyncProductCategoriesCommand;

/**
 * Interceptor class for @see \Taxjar\SalesTax\Console\Command\SyncProductCategoriesCommand
 */
class Interceptor extends \Taxjar\SalesTax\Console\Command\SyncProductCategoriesCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \Taxjar\SalesTax\Model\Logger $logger, \Taxjar\SalesTax\Observer\ImportCategories $importCategories)
    {
        $this->___init();
        parent::__construct($state, $logger, $importCategories);
    }
