<?php
namespace Taxjar\SalesTax\Console\Command\SyncTransactionsCommand;

/**
 * Interceptor class for @see \Taxjar\SalesTax\Console\Command\SyncTransactionsCommand
 */
class Interceptor extends \Taxjar\SalesTax\Console\Command\SyncTransactionsCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \Magento\Framework\Event\Manager $eventManager, \Taxjar\SalesTax\Model\Logger $logger, \Taxjar\SalesTax\Observer\BackfillTransactions $backfillTransactions)
    {
        $this->___init();
        parent::__construct($state, $eventManager, $logger, $backfillTransactions);
    }
