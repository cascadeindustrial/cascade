...
class Interceptor extends \Magento\Framework\Pricing\Render\RendererPool implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function createPriceRender($priceCode, \Magento\Framework\Pricing\SaleableInterface $saleableItem, array $data = [])
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('createPriceRender', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function createAmountRender(\Magento\Framework\Pricing\Amount\AmountInterface $amount, ?\Magento\Framework\Pricing\SaleableInterface $saleableItem = null, ?\Magento\Framework\Pricing\Price\PriceInterface $price = null, array $data = [])
    {
        ...
        if (!$pluginInfo) {
            return parent::createAmountRender($amount, $saleableItem, $price, $data);
        } else {
            return $this->___callPlugins('createAmountRender', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAdjustmentRenders(?\Magento\Framework\Pricing\SaleableInterface $saleableItem = null, ?\Magento\Framework\Pricing\Price\PriceInterface $price = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getAdjustmentRenders($saleableItem, $price);
        } else {
            return $this->___callPlugins('getAdjustmentRenders', func_get_args(), $pluginInfo);
        }
    }
