...
class Interceptor extends \Magento\ImportExport\Block\Adminhtml\Export\Filter implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function decorateFilter($value, \Magento\Eav\Model\Entity\Attribute $row, \Magento\Framework\DataObject $column, $isExport)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'decorateFilter');
        if (!$pluginInfo) {
            return parent::decorateFilter($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('decorateFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFilterElementId');
        if (!$pluginInfo) {
            return parent::getFilterElementId($attributeCode);
        } else {
            return $this->___callPlugins('getFilterElementId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFilterElementName');
        if (!$pluginInfo) {
            return parent::getFilterElementName($attributeCode);
        } else {
            return $this->___callPlugins('getFilterElementName', func_get_args(), $pluginInfo);
        }
    }
