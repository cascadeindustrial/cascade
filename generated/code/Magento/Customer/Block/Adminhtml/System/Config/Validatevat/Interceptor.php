...
class Interceptor extends \Magento\Customer\Block\Adminhtml\System\Config\Validatevat implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setMerchantCountryField($countryField)
    {
        ...
        if (!$pluginInfo) {
            return parent::setMerchantCountryField($countryField);
        } else {
            return $this->___callPlugins('setMerchantCountryField', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMerchantCountryField()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMerchantCountryField();
        } else {
            return $this->___callPlugins('getMerchantCountryField', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setMerchantVatNumberField($vatNumberField)
    {
        ...
        if (!$pluginInfo) {
            return parent::setMerchantVatNumberField($vatNumberField);
        } else {
            return $this->___callPlugins('setMerchantVatNumberField', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMerchantVatNumberField()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMerchantVatNumberField();
        } else {
            return $this->___callPlugins('getMerchantVatNumberField', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setVatButtonLabel($vatButtonLabel)
    {
        ...
        if (!$pluginInfo) {
            return parent::setVatButtonLabel($vatButtonLabel);
        } else {
            return $this->___callPlugins('setVatButtonLabel', func_get_args(), $pluginInfo);
        }
    }
