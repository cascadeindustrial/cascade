...
class Interceptor extends \Mageplaza\Blog\Controller\Adminhtml\Category\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initCategory');
        if (!$pluginInfo) {
            return parent::initCategory($register, $isSave);
        } else {
            return $this->___callPlugins('initCategory', func_get_args(), $pluginInfo);
        }
    }
