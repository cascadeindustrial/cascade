<?php
namespace Mageplaza\Blog\Block\Adminhtml\Category\Edit\Tabs;

/**
 * Interceptor class for @see \Mageplaza\Blog\Block\Adminhtml\Category\Edit\Tabs
 */
class Interceptor extends \Mageplaza\Blog\Block\Adminhtml\Category\Edit\Tabs implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Framework\Registry $coreRegistry, \Magento\Framework\Json\EncoderInterface $jsonEncoder, \Magento\Backend\Model\Auth\Session $authSession, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $coreRegistry, $jsonEncoder, $authSession, $data);
    }
