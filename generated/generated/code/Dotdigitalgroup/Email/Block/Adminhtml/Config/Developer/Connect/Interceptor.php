...
class Interceptor extends \Dotdigitalgroup\Email\Block\Adminhtml\Config\Developer\Connect implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_isSecureUrl');
        if (!$pluginInfo) {
            return parent::_isSecureUrl();
        } else {
            return $this->___callPlugins('_isSecureUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAuthoriseUrl');
        if (!$pluginInfo) {
            return parent::getAuthoriseUrl();
        } else {
            return $this->___callPlugins('getAuthoriseUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('_getElementHtml', func_get_args(), $pluginInfo);
        }
    }
