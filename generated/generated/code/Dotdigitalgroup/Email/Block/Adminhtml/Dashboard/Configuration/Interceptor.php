...
class Interceptor extends \Dotdigitalgroup\Email\Block\Adminhtml\Dashboard\Configuration implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_prepareRequestParams');
        if (!$pluginInfo) {
            return parent::_prepareRequestParams();
        } else {
            return $this->___callPlugins('_prepareRequestParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_resetRequestParams');
        if (!$pluginInfo) {
            return parent::_resetRequestParams();
        } else {
            return $this->___callPlugins('_resetRequestParams', func_get_args(), $pluginInfo);
        }
    }
