<?php
namespace AuthorizeNet\Webhooks\Model\Payment\Webhook;

/**
 * Interceptor class for @see \AuthorizeNet\Webhooks\Model\Payment\Webhook
 */
class Interceptor extends \AuthorizeNet\Webhooks\Model\Payment\Webhook implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\AuthorizeNet\Core\Gateway\Config\Config $config)
    {
        $this->___init();
