...
class Interceptor extends \MageWorx\SeoAll\Model\ResourceModel\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resolveEntityId');
        if (!$pluginInfo) {
            return parent::resolveEntityId($entityId);
        } else {
            return $this->___callPlugins('resolveEntityId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeValues');
        if (!$pluginInfo) {
            return parent::getAttributeValues($attribute, $entityId);
        } else {
            return $this->___callPlugins('getAttributeValues', func_get_args(), $pluginInfo);
        }
    }
