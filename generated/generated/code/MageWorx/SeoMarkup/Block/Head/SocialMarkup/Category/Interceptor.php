...
class Interceptor extends \MageWorx\SeoMarkup\Block\Head\SocialMarkup\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\MageWorx\SeoMarkup\Helper\Category $helperCategory, \MageWorx\SeoMarkup\Helper\Website $helperWebsite, \Magento\Framework\Registry $registry, \Magento\Framework\View\Element\Template\Context $context, array $data)
    {
        $this->___init();
        parent::__construct($helperCategory, $helperWebsite, $registry, $context, $data);
    }
    ...
    public function getPreparedUrl() : string
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getPreparedUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOgImageData');
        if (!$pluginInfo) {
            return parent::getOgImageData();
        } else {
            return $this->___callPlugins('getOgImageData', func_get_args(), $pluginInfo);
        }
    }
