...
class Interceptor extends \Cart2Quote\Quotation\Model\Session implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadProductComments');
        if (!$pluginInfo) {
            return parent::loadProductComments();
        } else {
            return $this->___callPlugins('loadProductComments', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'fullSessionClear');
        if (!$pluginInfo) {
            return parent::fullSessionClear();
        } else {
            return $this->___callPlugins('fullSessionClear', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'updateLastQuote');
        if (!$pluginInfo) {
            return parent::updateLastQuote($quotation);
        } else {
            return $this->___callPlugins('updateLastQuote', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addGuestFieldData');
        if (!$pluginInfo) {
            return parent::addGuestFieldData($config);
        } else {
            return $this->___callPlugins('addGuestFieldData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addMergeData');
        if (!$pluginInfo) {
            return parent::addMergeData($type, $newConfig);
        } else {
            return $this->___callPlugins('addMergeData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addConfigData');
        if (!$pluginInfo) {
            return parent::addConfigData($config);
        } else {
            return $this->___callPlugins('addConfigData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductData');
        if (!$pluginInfo) {
            return parent::addProductData($config);
        } else {
            return $this->___callPlugins('addProductData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFieldData');
        if (!$pluginInfo) {
            return parent::addFieldData($config);
        } else {
            return $this->___callPlugins('addFieldData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setQuotationQuote');
        if (!$pluginInfo) {
            return parent::setQuotationQuote($isQuotationQuote);
        } else {
            return $this->___callPlugins('setQuotationQuote', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQuotationQuote');
        if (!$pluginInfo) {
            return parent::getQuotationQuote();
        } else {
            return $this->___callPlugins('getQuotationQuote', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSkipLoadCustomer');
        if (!$pluginInfo) {
            return parent::setSkipLoadCustomer($skip);
        } else {
            return $this->___callPlugins('setSkipLoadCustomer', func_get_args(), $pluginInfo);
        }
    }
