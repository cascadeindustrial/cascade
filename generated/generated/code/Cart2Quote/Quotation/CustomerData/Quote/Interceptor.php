<?php
namespace Cart2Quote\Quotation\CustomerData\Quote;

/**
 * Interceptor class for @see \Cart2Quote\Quotation\CustomerData\Quote
 */
class Interceptor extends \Cart2Quote\Quotation\CustomerData\Quote implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Stdlib\DateTime $dateTime, \Cart2Quote\Quotation\Model\Session $checkoutSession, \Magento\Catalog\Model\ResourceModel\Url $catalogUrl, \Cart2Quote\Quotation\Model\QuotationCart $checkoutCart, \Magento\Checkout\Helper\Data $checkoutHelper, \Magento\Checkout\CustomerData\ItemPoolInterface $itemPoolInterface, \Magento\Framework\View\LayoutInterface $layout, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, array $data = [])
    {
        $this->___init();
        parent::__construct($dateTime, $checkoutSession, $catalogUrl, $checkoutCart, $checkoutHelper, $itemPoolInterface, $layout, $scopeConfig, $data);
    }
