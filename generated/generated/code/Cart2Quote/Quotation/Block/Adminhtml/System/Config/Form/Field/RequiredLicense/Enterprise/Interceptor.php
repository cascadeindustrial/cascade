<?php
namespace Cart2Quote\Quotation\Block\Adminhtml\System\Config\Form\Field\RequiredLicense\Enterprise;

/**
 * Interceptor class for @see \Cart2Quote\Quotation\Block\Adminhtml\System\Config\Form\Field\RequiredLicense\Enterprise
 */
class Interceptor extends \Cart2Quote\Quotation\Block\Adminhtml\System\Config\Form\Field\RequiredLicense\Enterprise implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Cart2Quote\Quotation\Helper\Data\LicenseInterface $license, \Cart2Quote\Quotation\Helper\Data\Metadata $metadata, \Magento\Backend\Block\Template\Context $context, $template = 'Cart2Quote_Quotation::system/config/form/field/requiredLicense/enterprise.phtml', array $data = [])
    {
        $this->___init();
        parent::__construct($license, $metadata, $context, $template, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAllowedForEdition');
        if (!$pluginInfo) {
            return parent::isAllowedForEdition();
        } else {
            return $this->___callPlugins('isAllowedForEdition', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCart2quoteComparisonUrl');
        if (!$pluginInfo) {
            return parent::getCart2quoteComparisonUrl();
        } else {
            return $this->___callPlugins('getCart2quoteComparisonUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCart2QuoteUrl');
        if (!$pluginInfo) {
            return parent::getCart2QuoteUrl();
        } else {
            return $this->___callPlugins('getCart2QuoteUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCart2QuoteSupportPageUrl');
        if (!$pluginInfo) {
            return parent::getCart2QuoteSupportPageUrl();
        } else {
            return $this->___callPlugins('getCart2QuoteSupportPageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCart2QuoteUpgradeUrl');
        if (!$pluginInfo) {
            return parent::getCart2QuoteUpgradeUrl();
        } else {
            return $this->___callPlugins('getCart2QuoteUpgradeUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCart2QuotReleaseNotesUrl');
        if (!$pluginInfo) {
            return parent::getCart2QuotReleaseNotesUrl($version);
        } else {
            return $this->___callPlugins('getCart2QuotReleaseNotesUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCart2QuoteUpdateUrl');
        if (!$pluginInfo) {
            return parent::getCart2QuoteUpdateUrl();
        } else {
            return $this->___callPlugins('getCart2QuoteUpdateUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLink($href, $value, $target = '_blank')
    {
        ...
        if (!$pluginInfo) {
            return parent::getLink($href, $value, $target);
        } else {
