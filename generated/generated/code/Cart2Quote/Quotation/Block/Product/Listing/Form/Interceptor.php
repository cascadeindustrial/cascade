<?php
namespace Cart2Quote\Quotation\Block\Product\Listing\Form;

/**
 * Interceptor class for @see \Cart2Quote\Quotation\Block\Product\Listing\Form
 */
class Interceptor extends \Cart2Quote\Quotation\Block\Product\Listing\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Cart2Quote\Quotation\Helper\QuotationCart $quotationCartHelper, \Cart2Quote\Quotation\Helper\Data $quotationHelper, \Magento\Customer\Model\Session $customerSession, \Magento\Catalog\Block\Product\Context $context, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showQuoteButton');
        if (!$pluginInfo) {
            return parent::showQuoteButton();
        } else {
            return $this->___callPlugins('showQuoteButton', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showMessageNotLoggedIn');
        if (!$pluginInfo) {
            return parent::showMessageNotLoggedIn();
        } else {
            return $this->___callPlugins('showMessageNotLoggedIn', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWidgetAddToQuoteUrl');
        if (!$pluginInfo) {
            return parent::getWidgetAddToQuoteUrl($additional);
        } else {
            return $this->___callPlugins('getWidgetAddToQuoteUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isQuotationFrontendVisible');
        if (!$pluginInfo) {
            return parent::isQuotationFrontendVisible();
        } else {
            return $this->___callPlugins('isQuotationFrontendVisible', func_get_args(), $pluginInfo);
        }
    }
