<?php
namespace Cart2Quote\Quotation\Plugin\Magento\Framework\Validator;

/**
 * Interceptor class for @see \Cart2Quote\Quotation\Plugin\Magento\Framework\Validator
 */
class Interceptor extends \Cart2Quote\Quotation\Plugin\Magento\Framework\Validator implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function afterIsValid($subject, $value)
    {
        ...
        if (!$pluginInfo) {
            return parent::afterIsValid($subject, $value);
        } else {
            return $this->___callPlugins('afterIsValid', func_get_args(), $pluginInfo);
        }
    }
