<?php
namespace Cart2Quote\Quotation\Plugin\Magento\Framework\View\Model\Layout\Merge;

/**
 * Interceptor class for @see \Cart2Quote\Quotation\Plugin\Magento\Framework\View\Model\Layout\Merge
 */
class Interceptor extends \Cart2Quote\Quotation\Plugin\Magento\Framework\View\Model\Layout\Merge implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function beforeAsString(\Magento\Framework\View\Model\Layout\Merge $subject)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'beforeAsString');
        if (!$pluginInfo) {
            return parent::beforeAsString($subject);
        } else {
            return $this->___callPlugins('beforeAsString', func_get_args(), $pluginInfo);
        }
    }
