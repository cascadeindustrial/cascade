<?php
namespace ParadoxLabs\Authnetcim\Model\Card;

/**
 * Interceptor class for @see \ParadoxLabs\Authnetcim\Model\Card
 */
class Interceptor extends \ParadoxLabs\Authnetcim\Model\Card implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\Api\ExtensionAttributesFactory $extensionFactory, \Magento\Framework\Api\AttributeValueFactory $customAttributeFactory, \ParadoxLabs\TokenBase\Model\Card\Context $cardContext, \Magento\Sales\Api\OrderPaymentRepositoryInterface $paymentRepository, ?\Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, ?\Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $registry, $extensionFactory, $customAttributeFactory, $cardContext, $paymentRepository, $resource, $resourceCollection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'importLegacyData');
        if (!$pluginInfo) {
            return parent::importLegacyData($payment);
        } else {
            return $this->___callPlugins('importLegacyData', func_get_args(), $pluginInfo);
        }
    }
