...
class Interceptor extends \Mageplaza\Blog\Model\Sitemap implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_initSitemapItems');
        if (!$pluginInfo) {
            return parent::_initSitemapItems();
        } else {
            return $this->___callPlugins('_initSitemapItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlogPostsSiteMapCollection');
        if (!$pluginInfo) {
            return parent::getBlogPostsSiteMapCollection();
        } else {
            return $this->___callPlugins('getBlogPostsSiteMapCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlogCategoriesSiteMapCollection');
        if (!$pluginInfo) {
            return parent::getBlogCategoriesSiteMapCollection();
        } else {
            return $this->___callPlugins('getBlogCategoriesSiteMapCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlogTagsSiteMapCollection');
        if (!$pluginInfo) {
            return parent::getBlogTagsSiteMapCollection();
        } else {
            return $this->___callPlugins('getBlogTagsSiteMapCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlogTopicsSiteMapCollection');
        if (!$pluginInfo) {
            return parent::getBlogTopicsSiteMapCollection();
        } else {
            return $this->___callPlugins('getBlogTopicsSiteMapCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSitemapItem');
        if (!$pluginInfo) {
            return parent::addSitemapItem($sitemapItem);
        } else {
            return $this->___callPlugins('addSitemapItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSitemapUrl');
        if (!$pluginInfo) {
            return parent::getSitemapUrl($sitemapPath, $sitemapFileName);
        } else {
            return $this->___callPlugins('getSitemapUrl', func_get_args(), $pluginInfo);
        }
    }
