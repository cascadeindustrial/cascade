<?php
namespace Mageplaza\Blog\Block\Adminhtml\Post\Edit\Tab\Product;

/**
 * Interceptor class for @see \Mageplaza\Blog\Block\Adminhtml\Post\Edit\Tab\Product
 */
class Interceptor extends \Mageplaza\Blog\Block\Adminhtml\Post\Edit\Tab\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Framework\Registry $coreRegistry, \Magento\Backend\Helper\Data $backendHelper, \Magento\Framework\App\RequestInterface $request, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $coreRegistry, $backendHelper, $request, $productCollectionFactory, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectedProducts');
        if (!$pluginInfo) {
            return parent::getSelectedProducts();
        } else {
            return $this->___callPlugins('getSelectedProducts', func_get_args(), $pluginInfo);
        }
    }
