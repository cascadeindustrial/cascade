...
class Interceptor extends \Mageplaza\Blog\Block\Post\RelatedProduct implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'relatedMode');
        if (!$pluginInfo) {
            return parent::relatedMode();
        } else {
            return $this->___callPlugins('relatedMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasProduct');
        if (!$pluginInfo) {
            return parent::hasProduct();
        } else {
            return $this->___callPlugins('hasProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getParentProductUrl');
        if (!$pluginInfo) {
            return parent::getParentProductUrl($product);
        } else {
            return $this->___callPlugins('getParentProductUrl', func_get_args(), $pluginInfo);
        }
    }
