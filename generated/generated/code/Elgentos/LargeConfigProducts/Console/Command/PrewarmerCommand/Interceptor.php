<?php
namespace Elgentos\LargeConfigProducts\Console\Command\PrewarmerCommand;

/**
 * Interceptor class for @see \Elgentos\LargeConfigProducts\Console\Command\PrewarmerCommand
 */
class Interceptor extends \Elgentos\LargeConfigProducts\Console\Command\PrewarmerCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Phrase\RendererInterface $phraseRenderer, \Magento\Framework\App\State $state, \Elgentos\LargeConfigProducts\Model\Prewarmer $prewarmer)
    {
        $this->___init();
        parent::__construct($phraseRenderer, $state, $prewarmer);
    }
