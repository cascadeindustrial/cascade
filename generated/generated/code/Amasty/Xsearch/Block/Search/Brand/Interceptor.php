...
class Interceptor extends \Amasty\Xsearch\Block\Search\Brand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Amasty\Xsearch\Helper\Data $xSearchHelper, \Magento\Framework\Stdlib\StringUtils $string, \Magento\Search\Model\QueryFactory $queryFactory, \Magento\Framework\Registry $coreRegistry, \Amasty\Xsearch\Model\Config $configProvider, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $xSearchHelper, $string, $queryFactory, $coreRegistry, $configProvider, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlockType');
        if (!$pluginInfo) {
            return parent::getBlockType();
        } else {
            return $this->___callPlugins('getBlockType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'generateCollection');
        if (!$pluginInfo) {
            return parent::generateCollection();
        } else {
            return $this->___callPlugins('generateCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIndexFulltextValues');
        if (!$pluginInfo) {
            return parent::getIndexFulltextValues();
        } else {
            return $this->___callPlugins('getIndexFulltextValues', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSearchUrl(\Magento\Framework\DataObject $item)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSearchUrl($item);
        } else {
    ...
    public function getDescription(\Magento\Framework\DataObject $item)
    {
        ...
        if (!$pluginInfo) {
            return parent::getDescription($item);
        } else {
    ...
    public function getSearchCollection()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSearchCollection();
        } else {
            return $this->___callPlugins('getSearchCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showDescription');
        if (!$pluginInfo) {
            return parent::showDescription($item);
        } else {
            return $this->___callPlugins('showDescription', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNameLength');
        if (!$pluginInfo) {
            return parent::getNameLength();
        } else {
            return $this->___callPlugins('getNameLength', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDescLength');
        if (!$pluginInfo) {
            return parent::getDescLength();
        } else {
            return $this->___callPlugins('getDescLength', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHighlightText');
        if (!$pluginInfo) {
            return parent::getHighlightText($descStripped);
        } else {
            return $this->___callPlugins('getHighlightText', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFullLink');
        if (!$pluginInfo) {
            return parent::getFullLink($url);
        } else {
            return $this->___callPlugins('getFullLink', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isNoFollow');
        if (!$pluginInfo) {
            return parent::isNoFollow();
        } else {
            return $this->___callPlugins('isNoFollow', func_get_args(), $pluginInfo);
        }
    }
