...
class Interceptor extends \Amasty\Xsearch\Block\Search\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIndexedIds');
        if (!$pluginInfo) {
            return parent::setIndexedIds($ids);
        } else {
            return $this->___callPlugins('setIndexedIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCompareProductsPostParams');
        if (!$pluginInfo) {
            return parent::getCompareProductsPostParams($productModel);
        } else {
            return $this->___callPlugins('getCompareProductsPostParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDescription(\Magento\Catalog\Model\Product $product)
    {
        ...
        if (!$pluginInfo) {
            return parent::getDescription($product);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUlrEncodedParam');
        if (!$pluginInfo) {
            return parent::getUlrEncodedParam();
        } else {
            return $this->___callPlugins('getUlrEncodedParam', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShowDescription');
        if (!$pluginInfo) {
            return parent::isShowDescription($product);
        } else {
            return $this->___callPlugins('isShowDescription', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'sortProducts');
        if (!$pluginInfo) {
            return parent::sortProducts($products);
        } else {
            return $this->___callPlugins('sortProducts', func_get_args(), $pluginInfo);
        }
    }
