...
class Interceptor extends \Amasty\CronScheduleList\Model\ScheduleCollection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastActivity');
        if (!$pluginInfo) {
            return parent::getLastActivity();
        } else {
            return $this->___callPlugins('getLastActivity', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removeActivitySchedule');
        if (!$pluginInfo) {
            return parent::removeActivitySchedule();
        } else {
            return $this->___callPlugins('removeActivitySchedule', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFailedScheduleByJobCode');
        if (!$pluginInfo) {
            return parent::getFailedScheduleByJobCode($jobCode);
        } else {
            return $this->___callPlugins('getFailedScheduleByJobCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastFailedJobs');
        if (!$pluginInfo) {
            return parent::getLastFailedJobs();
        } else {
            return $this->___callPlugins('getLastFailedJobs', func_get_args(), $pluginInfo);
        }
    }
