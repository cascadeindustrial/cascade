...
class Interceptor extends \Amasty\Base\Model\Response\File\FileOctetResponse implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function getReadResourceByPath(string $readResourcePath) : \Magento\Framework\Filesystem\File\ReadInterface
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getReadResourceByPath');
        if (!$pluginInfo) {
            return parent::getReadResourceByPath($readResourcePath);
        } else {
            return $this->___callPlugins('getReadResourceByPath', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'sendOctetResponse');
        if (!$pluginInfo) {
            return parent::sendOctetResponse();
        } else {
            return $this->___callPlugins('sendOctetResponse', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function setReadResource(\Magento\Framework\Filesystem\File\ReadInterface $readResource) : \Amasty\Base\Model\Response\OctetResponseInterface
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setReadResource');
        if (!$pluginInfo) {
            return parent::setReadResource($readResource);
        } else {
            return $this->___callPlugins('setReadResource', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function setFileName(string $fileName) : \Amasty\Base\Model\Response\OctetResponseInterface
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFileName');
        if (!$pluginInfo) {
            return parent::setFileName($fileName);
        } else {
            return $this->___callPlugins('setFileName', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function setContentType(string $contentType) : \Amasty\Base\Model\Response\OctetResponseInterface
    {
     ...
     * {@inheritdoc}
     */
    public function setContentLength(int $length) : \Amasty\Base\Model\Response\OctetResponseInterface
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setContentLength');
        if (!$pluginInfo) {
            return parent::setContentLength($length);
        } else {
            return $this->___callPlugins('setContentLength', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContentDisposition');
        if (!$pluginInfo) {
            return parent::getContentDisposition();
        } else {
            return $this->___callPlugins('getContentDisposition', func_get_args(), $pluginInfo);
        }
    }
