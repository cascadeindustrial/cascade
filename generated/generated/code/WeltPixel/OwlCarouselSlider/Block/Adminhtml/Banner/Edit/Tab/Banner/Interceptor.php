...
class Interceptor extends \WeltPixel\OwlCarouselSlider\Block\Adminhtml\Banner\Edit\Tab\Banner implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBanner');
        if (!$pluginInfo) {
            return parent::getBanner();
        } else {
            return $this->___callPlugins('getBanner', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showGaFields');
        if (!$pluginInfo) {
            return parent::showGaFields();
        } else {
            return $this->___callPlugins('showGaFields', func_get_args(), $pluginInfo);
        }
    }
